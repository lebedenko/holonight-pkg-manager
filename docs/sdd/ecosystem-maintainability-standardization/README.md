...
The pinned revision is unpublished (one commit ahead of origin/main). Product QML remains top-level and CMake installs the binary, but Task has no install/staging capability and backend dependencies include libalpm.
